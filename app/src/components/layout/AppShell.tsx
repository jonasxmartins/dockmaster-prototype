          ...
          <div className="flex items-center justify-between h-32">
            ...
            <div className="flex-1 flex justify-center">
              <button
                ...
                className="rounded-lg border border-white/20 bg-white/5 px-6 py-2 text-[11px] font-bold uppercase tracking-widest text-white/70 transition-all hover:bg-white/10 hover:text-white/90 hover:border-white/30"
              >
                View Tour
              </button>
            </div>
            ...
            <div className="flex-1 flex justify-end items-center gap-6">
              <div className="flex flex-col justify-center">
                ...
                <div className="relative">
                  <nav
                    className={cn(
                      "relative flex items-center bg-navy-light/50 backdrop-blur-sm border border-white/20 rounded-lg p-0.5 transition-all",
                      highlightDemoController &&
                        "ring-2 ring-teal/50 shadow-[0_0_16px_rgba(20,143,119,0.35)]"
                    )}
                  >
                    {highlightDemoController && (
                      <div
                        aria-hidden
                        className="pointer-events-none absolute -inset-1 rounded-lg border border-teal/40 animate-pulse"
                      />
                    )}
                    <button
                      onClick={() => handleSelectMode("guided")}
                      className={cn(
                        "px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-lg border border-transparent transition-all flex items-center gap-1",
                        mode === "guided"
                  ...
                  {highlightDemoController && (
                    <div className="absolute right-0 top-[calc(100%+16px)] z-30 w-80 overflow-hidden rounded-lg border border-border bg-white shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300">
